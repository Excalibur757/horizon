  ...
  return (
    <div className="min-h-screen bg-fundo text-white flex flex-col">
      ...
      <main className="flex flex-col items-center justify-center py-20 px-4 gap-40 flex-grow relative">
        ...
        <section className="mt-16 md:mt-24 lg:mt-32 relative w-full flex justify-center items-center">
          <img
            src="/inana.png"
            alt="Inana"
            className="absolute left-[20%] top-2 h-[250px] object-contain z-10 translate-y-[-100%]"
          />

          <img
            src="/Ray.png"
            alt="Ray"
            className="absolute right-[20%] top-3 h-[250px] object-contain z-10 translate-y-[-100%]"
          />
          <div className="relative z-10">
            <Card
